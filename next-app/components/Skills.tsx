        ...
        <div key={category} className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 text-center">
            {skills.map(({ name, icon }, idx) => {
              ...
              return (
                <div key={idx} className="flex flex-col items-center bg-[#2f2b2b] rounded-xl p-6 shadow hover:animate-pulse hover:scale-105 hover:smooth-transition duration-300">
                  <img
                    src={imgSrc}
                    alt={`${name} icon`}
