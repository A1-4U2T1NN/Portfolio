        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="flex gap-4">
            <a
              ...
              className="flex items-center gap-2 bg[#915f6e] text-white px-4 py-2 rounded-lg shadow bg-[#7f4f5b] hover:opacity-80 transition"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-[#282828] text-white px-4 py-2 rounded-lg shadow hover:opacity-80 transition"
            >
              <img
